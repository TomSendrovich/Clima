...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "5a8e4bbdc173fa54535e7a6bff7093a9";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeCityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //An object to navigate between layouts
                Intent myIntent = new Intent(WeatherController.this,ChangeCityController.class);
                //Start the new activity layout
    ...
    protected void onResume() {
        ...
        //If there is an Intent object (which means we came from ChangeCityController class)
        //we look for the weather at the city we entered.
        //else, looking for my location's weather.
        if (city!=null){
    ...
    private void getWeatherForNewCity(String city){
        //Building the http request for the weather
        RequestParams params = new RequestParams();
        //Adding the parameters as the API requires
        params.put("q", city);
